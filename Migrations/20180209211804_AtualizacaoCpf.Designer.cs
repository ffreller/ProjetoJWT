...
namespace modelobasicoefjwt.Migrations
{
    ...
    [Migration("20180209211804_AtualizacaoCpf")]
    partial class AtualizacaoCpf
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoJWT.Models.Permissao", b =>
                {
            ...
            modelBuilder.Entity("ProjetoJWT.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("ProjetoJWT.Models.UsuarioPermissao", b =>
                {
            ...
            modelBuilder.Entity("ProjetoJWT.Models.UsuarioPermissao", b =>
                {
                    b.HasOne("ProjetoJWT.Models.Permissao", "Permissao")
                        .WithMany("UsuariosPermissoes")
                        .HasForeignKey("IdPermissao")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ProjetoJWT.Models.Usuario", "Usuario")
                        .WithMany("UsuariosPermissoes")
